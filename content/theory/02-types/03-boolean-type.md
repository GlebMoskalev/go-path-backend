---
title: "Булевый тип"
description: "bool, short-circuit evaluation, идиоматические паттерны использования"
order: 3
---

# Булевый тип

Тип `bool` — один из самых простых в Go, но short-circuit evaluation и идиоматические паттерны его использования стоит разобрать отдельно.
...
Это не просто оптимизация — это гарантия языка. `&&` и `||` вычисляют правый операнд **только если это необходимо**.
