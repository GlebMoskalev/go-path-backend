...
В Go нет неявного преобразования типов — это одно из ключевых дизайнерских решений языка, которое поначалу кажется многословным, но на практике предотвращает целые классы ошибок.
