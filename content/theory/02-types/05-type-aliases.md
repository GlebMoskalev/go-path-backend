---
title: "Именованные типы и псевдонимы"
...
```go
type Celsius float64      // именованный тип (type definition)
...
### Методы на именованном типе

Это главная причина использовать именованный тип — можно добавить методы:
...
Именованные типы помогают предотвратить логические ошибки:
...
| Основное применение | Доменные типы, перечисления | Рефакторинг, совместимость |

---

## Практические примеры

### Типы для идентификаторов (именованный тип)
...
- `type T int` — **именованный тип**: отдельный, несовместимый с `int`, может иметь методы
- `type T = int` — **псевдоним**: синоним для `int`, полностью взаимозаменяем
- Именованный тип используй для семантической безопасности (UserID vs ProductID) и доменных типов
- Псевдоним используй для рефакторинга и обратной совместимости
